                        ...
                        (t, i) => {
                            ...
                            if (n) {
                                if (((t.innerHTML = ""), (t.title = n.title ?? ""), (t.className = `vapi-btn vapi-btn-is-${i}`), "connect" === n.type)) {
                                    ...
                                    (p.src =
                                        "https://media-hosting.imagekit.io/98b4e1178371440b/Audree_Proweaver.gif?Expires=1840676347&Key-Pair-Id=K2ZIVPTIP2VGHC&Signature=gkXicRt5p4KfZuENFhoNsrmRSyb~Q7L1V1nv~SJmw8RswRj7r6UV4NanNRrIrQz60l0qFWXCPFcjlf9wdHDu~CdjqWcXLG-jmwSiwJ4HE~wUm22Vh~ZiAzD61HzsWHP~fcVKd63C7ex2VsR4~Lp-2jYTda7proaKYvgBEJOj289VUPdQqkjf1QTEqs-Bmym05lrwd4MqgKtPJlSTK~o0wkI5IzuMxy6mdPf1jAZ67ilTy9vTSGU3hC6XN4Zr0f813fdaoFifNP~HVRyD3-GHtGk05r-n1u8eV3xcfXqjNntFsbEPapGrIl10Sy8hXFD6Y4~-fYqVRHigRB0c5LDa2g__"),
                                        (p.alt = "Agent GIF"),
